...
const AUDIOS_POR_TIPO = {
    "MEDICACAO": new Audio("./assets/audio/medicacao.mp3"),
    "HIDRATACAO": new Audio("./assets/audio/hidratacao.mp3"),
    "NEBULIZACAO": new Audio("./assets/audio/nebulizacao.mp3"),
    "SINAIS VITAIS": new Audio("./assets/audio/sinais-vitais.mp3"),
    "DIETA": new Audio("./assets/audio/dieta.mp3"),
    "HIGIENE": new Audio("./assets/audio/higiene.mp3"),
};
